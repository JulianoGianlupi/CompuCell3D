#ifndef COMPUCELL3DMOTILITYPOTENTIALPLUGIN_H
#define COMPUCELL3DMOTILITYPOTENTIALPLUGIN_H
...
#include "MotilityPotentialDLLSpecifier.h"
...
namespace CompuCell3D {
  ...
  class MotilityPotential_EXPORT MotilityPotentialParam{
  public:
	  MotilityPotentialParam(){
		  lambdaVec.x=0.0;
		  lambdaVec.y=0.0;
		  lambdaVec.z=0.0;
	  }
	...
	class MotilityPotential_EXPORT MotilityPotentialPlugin : public Plugin,public EnergyFunction
	{
    ...
    Dim3D fieldDim;
	 ...
	 std::vector<MotilityPotentialParam> MotilityPotentialParamVector;

	 typedef double (MotilityPotentialPlugin::*changeEnergy_t)(const Point3D &pt, const CellG *newCell,const CellG *oldCell);

	 MotilityPotentialPlugin::changeEnergy_t changeEnergyFcnPtr;

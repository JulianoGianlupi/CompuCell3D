...
%include <CompuCell3D/steppables/BiasVectorSteppable/BiasVectorSteppableData.h>
%template (BiasVectorSteppableDataAccessorTemplate) BasicClassAccessor<BiasVectorSteppableData>; //necessary to get BiasVectorSteppableData accessor working in Python
...
%include <CompuCell3D/plugins/ImplicitMotility/ImplicitMotilityData.h>
%template (ImplicitMotilityDataAccessorTemplate) BasicClassAccessor<ImplicitMotilityData>; //necessary to get ImplicitMotilityData accessor working in Python
...
%inline %{
 OrientedGrowthPlugin * getOrientedGrowthPlugin(){
      return (OrientedGrowthPlugin *)Simulator::pluginManager.get("OrientedGrowth");
   }
...
%template (ContactOrientationDataAccessorTemplate) BasicClassAccessor<ContactOrientationData>; //necessary to get ContactOrientationData accessor working in Python
...
// 
// %inline %{
//  ContactOrientationPlugin * getContactOrientationPlugin(){
//       return (ContactOrientationPlugin *)Simulator::pluginManager.get("ContactOrientation");
//    }
// 
// %}
...
%inline %{
 Polarization23Plugin * getPolarization23Plugin(){
      return (Polarization23Plugin *)Simulator::pluginManager.get("Polarization23");
   }
...
%inline %{
 ClusterSurfacePlugin * getClusterSurfacePlugin(){
      return (ClusterSurfacePlugin *)Simulator::pluginManager.get("ClusterSurface");
   }
...
%inline %{
 ClusterSurfaceTrackerPlugin * getClusterSurfaceTrackerPlugin(){
      return (ClusterSurfaceTrackerPlugin *)Simulator::pluginManager.get("ClusterSurfaceTracker");
   }
